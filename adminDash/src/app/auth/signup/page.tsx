...
const SignUp: React.FC = () => {
  ...
  async function signUp(e:any) {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/company/register`, {
      method: 'POST',
      headers: {
  ...
  return (
    <div className="flex px-36 py-16">

      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 flex mx-auto justify-center" href="/">
                <Image
              ...
              <p className="2xl:px-20">
                Welcome to the Vikas Admin. Streamline your company's offerings by effortlessly creating customized coupons for our personal finance app.             
              </p>
